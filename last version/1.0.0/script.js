...
function get_data_storage(){
	...
	const ambil = data.trim() ? JSON.parse(data) : new Array();
	const ceklistEsok = cekChecklist(ambil);

	console.log(ceklistEsok)
...
function bin_id(){
	return '636c71732b3499323bfb43f7'
}

function master_key(){
	return '$2b$10$ccGM0WKEWD0bdaANFD7LIOqliu3Hy5EaDIntILvgs3hdFm7Egk9Te'
}
